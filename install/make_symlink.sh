...
ln -sfn "$HYPRLAND_UBUNTU_DIR/kitty/kitty.desktop" ~/.local/share/applications/kitty.desktop
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/walker.service" ~/.config/systemd/user/graphical-session.target.wants/walker.service
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/walker.service" ~/.config/systemd/user/walker.service
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/hyprpolkitagent.service.d" ~/.config/systemd/user/hyprpolkitagent.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/elephant.service.d" ~/.config/systemd/user/elephant.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/hypridle.service.d" ~/.config/systemd/user/hypridle.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/hyprpaper.service.d" ~/.config/systemd/user/hyprpaper.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/mako.service.d" ~/.config/systemd/user/mako.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/swayosd.service.d" ~/.config/systemd/user/swayosd.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/walker.service.d" ~/.config/systemd/user/walker.service.d
...
ln -sfn "$HYPRLAND_UBUNTU_DIR/systemd/waybar.service.d" ~/.config/systemd/user/waybar.service.d

if [[ -d "$HOME/.config/btop" ]] && [[ ! -L "$HOME/.config/btop" ]]; then
    mv "$HOME/.config/btop" "$HOME/.config/btop.bak.$(date +%Y%m%d_%H%M%S)"
fi

ln -sfn "$HYPRLAND_UBUNTU_DIR/btop" ~/.config/btop

mkdir -p "$HOME/.config/btop/themes"

ln -sfn "$HYPRLAND_UBUNTU_DIR/current-hyprland-ubuntu/theme/btop.theme" ~/.config/btop/themes/current.theme

if [[ -d "$HOME/.config/mako" ]] && [[ ! -L "$HOME/.config/mako" ]]; then
    mv "$HOME/.config/mako" "$HOME/.config/mako.bak.$(date +%Y%m%d_%H%M%S)"
fi

ln -sfn "$HYPRLAND_UBUNTU_DIR/mako" ~/.config/mako
ln -sfn "$HYPRLAND_UBUNTU_DIR/current-hyprland-ubuntu/theme/mako.ini" ~/.config/mako/config
